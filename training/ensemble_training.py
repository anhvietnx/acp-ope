...
inFastaTrain="/home/anhvietnx1/acp-ope/data/ACP20mainTrain.fasta"
inFastaTest="/home/anhvietnx1/acp-ope/data/ACP20mainTest.fasta"
...
#model esemble
import joblib
model1 = joblib.load(filename='/home/anhvietnx1/acp-ope/bilstm_attention_main7632.joblib')
model2 = joblib.load(filename='/home/anhvietnx1/acp-ope/models/lgbm_main7865.joblib')
#model3 = joblib.load(filename='xgboost_main7661.joblib')
#model4 = joblib.load(filename='bilstm_main7690.joblib')
model5 = joblib.load(filename='/home/anhvietnx1/acp-ope/models/CNN_SF_144.joblib')
...
x_test_oe = np.load("/home/anhvietnx1/acp-ope/models/x_test_oe.npy")
SF_test = np.load("/home/anhvietnx1/acp-ope/models/SF_ALL_K_test.npy")
